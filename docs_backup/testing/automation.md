...
**Nota:** Esta documentación está disponible también en formato desglosado en carpetas separadas para facilitar lectura:
- [Arquitectura del Proyecto](automation/arquitectura.md)
- [Estructura de Pruebas](automation/estructura-pruebas.md)
- [Mejores Prácticas](automation/mejores-practicas.md)
